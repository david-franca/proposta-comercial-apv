...
export const PDFDoc = () => {
  ...
  const proposal1 = numero.porExtenso(pdf.total, "monetario");
  const proposal2 = numero.porExtenso(pdf.total - 200, "monetario");
    ...
    <Document>
        ...
        <View id="container" style={styles.container}>
          ...
          <View id="descriptions" style={styles.descriptions}>
            <View id="contract" style={styles.row}>
              ...
              <Text>
                Sr(a). {pdf.fullName} - {pdf.cellPhone}
              </Text>
            </View>
          ...
          <View id="group1" style={[styles.content, styles.regular]}>
            <View>
              ...
              <Text>
                Taxa administrativa com proteção roubo e furto: {currencyBRL(pdf.admin + 200)}
              </Text>
              {parseFloat(pdf.discount) > 0 ? (
          ...
          <View style={styles.footer}>
            <Text>
              Rua Guarani 58, Paupina. Fortaleza - CE, CEP 60.873-530, CNPJ nº 12.460.490/0002-79
            </Text>
          </View>
        </View>
      </Page>
      <Page size="A4" style={styles.page}>
        <View id="container" style={styles.container}>
          ...
          <View id="total" style={styles.row}>
            <Text>
              <Text style={[styles.bold, styles.uppercase]}>
                Valor total da adesão: {currencyBRL(pdf.total - 200)}{" "}
              </Text>
          ...
          <View style={[styles.row, { paddingVertical: 8 }]}>
            ...
            <Text style={[styles.bold, styles.uppercase]}>Proteção roubo e furto: R$ 200,00</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.uppercase}>
              Estimativa de rateio com {pdf.cotas} cotas de participação:{" "}
      ...
      <Page size="A4" style={styles.page}>
        <View id="container" style={styles.container}>
          ...
          <View>
            <Text>
              - Nenhuma das propostas incluem seguro contra terceiros, para o mesmo, considerar o
              acréscimo de R$ 190,00 ({numero.porExtenso(190, "monetario")}) para inclusão através
              de parceiros;
            </Text>
