...
export const handleErrorFirebase = (error: AuthError): string => {
  switch (error.code) {
    ...
    case "auth/invalid-action-code":
      return "O código da ação é inválido. Isso pode acontecer se o código estiver mal formatado ou já tiver sido usado.";
