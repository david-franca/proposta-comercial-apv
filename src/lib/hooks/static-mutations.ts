...
const setDoc = <Data extends DocumentData, Doc extends Document = Document<Data>>(
  path: string | null,
  ...
  collectionCache.getSWRKeysFromCollectionPath(ref.parent.path).forEach((key) => {
    mutate(
      key,
...
const updateDoc = <Data extends DocumentData, Doc extends Document = Document<Data>>(
  path: string | null,
...
const deleteDoc = <Data extends DocumentData, Doc extends Document = Document<Data>>(
  path: string | null,
  /**
...
export { setDoc, updateDoc, deleteDoc, revalidateDoc, revalidateCollection, shouldMerge };
